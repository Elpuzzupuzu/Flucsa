    ...
    return (
        <div className="flex flex-col items-center text-center mb-6 pb-6 border-b border-gray-200">
            ...
            <div className="relative group mb-3">
                {profilePicture ? (
                    <img
                        ...
                        className="w-24 h-24 sm:w-28 sm:h-28 rounded-full object-cover border-3 border-indigo-100 shadow-lg ring-2 ring-indigo-50"
                        onError={(e) => {
                    ...
                    <div className="w-24 h-24 sm:w-28 sm:h-28 flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600 text-white font-bold text-3xl rounded-full shadow-lg border-3 border-indigo-100 ring-2 ring-indigo-50">
                        {userInitials}
                    </div>
                )}
                ...
                <button 
                    className="absolute bottom-0 right-0 bg-indigo-600 hover:bg-indigo-700 text-white p-2 rounded-full shadow-md transition-all duration-200 transform hover:scale-110"
            ...
            <div>
                ...
                <p className="text-sm text-gray-600 mb-2">{user.correo || user.email}</p>
...
const ProfileDetailsForm = ({ user, dispatch, loading, error, successMessage }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-5">
            <h3 className="text-lg font-bold text-gray-800 pb-2 border-b border-gray-200">Editar Detalles</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="block w-full border border-gray-300 rounded-lg shadow-sm p-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all text-sm"
                        required
                    />
                </div>
                ...
                {/* Input Apellido */}
                <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1.5" htmlFor="apellido">
                        Apellido
                    </label>
                    <input
                        type="text"
            ...
            <div>
                ...
                <input
                    ...
                    onChange={handleChange}
                    className="block w-full border border-gray-300 rounded-lg shadow-sm p-2.5 bg-gray-50 text-sm cursor-not-allowed"
                    disabled
                />
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-4 rounded-lg border border-indigo-200">
                                    <div className="flex items-center gap-2 mb-1.5">
                                        ...
                                        <p className="text-xs font-semibold text-indigo-700">Nombre Completo</p>
                                    </div>
                                    <p className="text-base font-bold text-gray-900 ml-9">{userName}</p>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg border border-purple-200">
                                    <div className="flex items-center gap-2 mb-1.5">
                                        ...
                                        <p className="text-xs font-semibold text-purple-700">Correo Electrónico</p>
                                    </div>
                                    <p className="text-base font-bold text-gray-900 ml-9 break-words">{userEmail}</p>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
                                    <div className="flex items-center gap-2 mb-1.5">
                                        ...
                                        <p className="text-xs font-semibold text-blue-700">Tipo de Usuario</p>
                                    </div>
                                    <p className="text-base font-bold text-gray-900 ml-9">{userRole}</p>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg border border-green-200">
                                    <div className="flex items-center gap-2 mb-1.5">
                                        ...
                                        <p className="text-xs font-semibold text-green-700">Miembro desde</p>
                                    </div>
                                    <p className="text-sm font-bold text-gray-900 ml-9">{memberSince}</p>
                                </div>
                            </div>
                        </div>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-6">
                    <h1 className="text-3xl font-extrabold text-gray-900 mb-1">Mi Perfil</h1>
                    <p className="text-sm text-gray-600">Gestiona tu información personal y preferencias</p>
                </div>

                <div className="flex flex-col lg:flex-row gap-5">
                    {/* Panel de Navegación Lateral */}
                    <aside className="w-full lg:w-64 bg-white p-5 rounded-xl shadow-lg border border-gray-100 flex-shrink-0 h-fit sticky top-24">
                    ...
                    {/* Contenido Principal */}
                    <main className="flex-1 bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                        {renderContent()}
                    </main>
                </div>
            </div>
