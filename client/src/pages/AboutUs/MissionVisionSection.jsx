            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-24">
                ...
                >
                    ...
                    <div className="space-y-3">
                        {CheckCircleIcon && ['Calidad Premium','Servicio Confiable','Innovación Continua','Desarrollo Sostenible'].map((text, i) => (
                ...
                >
                    ...
                    <div className="space-y-3">
                        {StarIcon && ['Liderazgo Nacional','Excelencia Reconocida','Adaptabilidad','Innovación Constante'].map((text, i) => (
                            <div key={i} className="flex items-center text-gray-700">
