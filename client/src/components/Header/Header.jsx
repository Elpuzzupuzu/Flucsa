...
  const rol = useSelector((state) => state.user.user?.rol); // Extracción del rol

  // 🔑 CAMBIO 1: EXTRAER LA FOTO DE PERFIL DEL ESTADO DE REDUX
...
                  rol={rol}
                  // 🔑 CAMBIO 2: PASAR LA FOTO DE PERFIL COMO PROP
...
            {/* Pasar el rol al Navigation de escritorio */}
            <Navigation rol={rol} /> 
          </div>
        </div>
...
                isLoggedIn={isLoggedIn}
                onLogout={handleLogout}
                rol={rol} // Pasar el rol al Navigation móvil
              />
            </div>
          </div>
        </div>
