...
import cookieParser from "cookie-parser";
import "express-async-errors"; // Manejo de errores async
import path from "path"; // Importar 'path' que falta en el código proporcionado
import { fileURLToPath } from "url"; // Importar 'fileURLToPath' que falta en el código proporcionado
...
import whishListRoutes from "./routes/wishListRoutes.js"; // Rutas de lista de deseos
import pdfRoutes from "./routes/pdfRoutes.js"; // Rutas para catálogo PDF
import cartRoutes from "./routes/cartRoutes.js"; //Rutas del carrito de compras
...
// =======================================================
// 🚨 SOLUCIÓN CRÍTICA PARA COOKIES EN RENDER/PROXY 🚨
// Le indica a Express que confíe en los encabezados X-Forwarded-Proto
// enviados por el balanceador de carga de Render.
// Esto permite que Express sepa que la solicitud es HTTPS.
...
// =======================================================
// 🧱 SERVIR FRONTEND DE REACT (VITE) EN PRODUCCIÓN (Si aplica)
// (Restaurando lógica de servir el frontend que estaba en el código comentado)
// =======================================================
const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);
const clientDistPath = path.join(__dirname, "../../client/dist");
